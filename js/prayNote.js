...
const createBookmark = () => {
    ...
    bookmark1.style.width = '100px'
    bookmark1.style.height = '100px'
    bookmark1.style.position = 'absolute'
    bookmark1.style.top = '17%'
    bookmark1.style.right = '30px'
    bookmark1.style.zIndex = '1'
    bookmark1.style.opacity = '0.5'
    bookmark1.style.backgroundColor = 'red'
    bookmark1.style.borderRadius = '10px'
    bookmark1.style.cursor = 'pointer'
    document.body.appendChild(bookmark1)

    const bookmark2 = document.createElement('div')
    bookmark2.className = 'bookmark2'
    bookmark2.style.width = '100px'
    bookmark2.style.height = '100px'
    bookmark2.style.position = 'absolute'
    bookmark2.style.top = '30%'
    bookmark2.style.right = '30px'
    bookmark2.style.zIndex = '1'
    bookmark2.style.opacity = '0.5'
    bookmark2.style.backgroundColor = 'green'
    bookmark2.style.borderRadius = '10px'
    bookmark2.style.cursor = 'pointer'
    document.body.appendChild(bookmark2)
    
    const bookmark3 = document.createElement('div')
    bookmark3.className = 'bookmark3'
    bookmark3.style.width = '100px'
    bookmark3.style.height = '100px'
    bookmark3.style.position = 'absolute'
    bookmark3.style.top = '43%'
    bookmark3.style.right = '30px'
    bookmark3.style.zIndex = '1'
    bookmark3.style.opacity = '0.5'
    bookmark3.style.backgroundColor = 'blue'
    bookmark3.style.borderRadius = '10px'
    bookmark3.style.cursor = 'pointer'
