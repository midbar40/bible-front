...
const saveSermon = async () => {
    ...
    const saveSermon = await fetch('https://solascriptura-env.eba-tk2vnisc.ap-southeast-2.elasticbeanstalk.com/api/sermon/saveSermon', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
const getSermon = async () => {
    const response = await fetch('https://solascriptura-env.eba-tk2vnisc.ap-southeast-2.elasticbeanstalk.com/api/sermon/getSermon', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
const showSermonDetail = async (clickedSermonId) => {
    const response = await fetch('https://solascriptura-env.eba-tk2vnisc.ap-southeast-2.elasticbeanstalk.com/api/sermon/getSermonDetail', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
const editSermon = async (clickedSermonId) => {
    ...
    const sermonTakeaway = document.querySelector('#sermon-takeaway')
    console.log('sermonDate.value :', sermonDate.value)
    const response = await fetch('https://solascriptura-env.eba-tk2vnisc.ap-southeast-2.elasticbeanstalk.com/api/sermon/editSermon', {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json'
        },
...
function activeSermonRightClick(e) {
    ...
    rightClickMenuDelete.addEventListener('click', async function (e) {
        if (confirm('정말 삭제하시겠습니까?') === false) return
            ...
            await fetch('https://solascriptura-env.eba-tk2vnisc.ap-southeast-2.elasticbeanstalk.com/api/sermon/deleteSermon',
                {
                    method: 'DELETE',
                    headers: {
                        'Content-Type': 'application/json',
