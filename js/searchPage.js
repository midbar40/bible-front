...
async function getBibleData(searchWord) {
    try {
        const data = await fetch(`http://solascriptura-env.eba-tk2vnisc.ap-southeast-2.elasticbeanstalk.com/api/bible/search?query=${searchWord}`)
...
async function fetchItems() {
    try {
        const reponse = await fetch(`http://solascriptura-env.eba-tk2vnisc.ap-southeast-2.elasticbeanstalk.com/api/bible/search?query=${searchWord}&page=${page}`)
